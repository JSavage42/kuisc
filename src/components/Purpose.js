...
const Purpose = () => (
  <section className="about-purpose">
    ...
    <ul>
      ...
      <li>
        Provide students with access to a network of professionals in the cyber
        security fields.
      </li>
      <li>
    ...
    <ul>
      <li>
        We host bi-weekly meetings. All of our meetings are open to everyone, so
        anyone is more that welcome to attend and get involved. Check the
        calendar for dates.
        <ul>
